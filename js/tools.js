...
(function () {
  ...
  // (Phase 3 cybersecurity-rating tools — IP recon, web-score, CVE search —
  //  were retired when ionet's positioning shifted to network engineering.
  //  Backend routers and frontend pages removed; restore from git history.)
